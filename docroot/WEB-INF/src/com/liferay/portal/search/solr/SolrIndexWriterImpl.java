...
import com.liferay.portal.search.solr.server.SolrServerFactory;
import com.liferay.portal.search.solr.server.SolrServerWrapper;
...
public class SolrIndexWriterImpl implements IndexWriter {
	...
	public void addDocument(SearchContext searchContext, Document document)
		...
		_log.debug("Attempting to add content "+document.getUID());
		
		try {
			SolrServerWrapper _solrServerWrapper = _solrServerFactory.getLiveServer();
			_solrServerWrapper.incrementInvocationCount();
			SolrServer _solrServer = _solrServerWrapper.getServer();
			_log.debug("Running on SolrServer : "+_solrServerWrapper.getId());
	...
	public void addDocuments(
		...
		_log.debug("Attempting to add a collection of contents");
	...
	public void deleteDocument(SearchContext searchContext, String uid)
		...
		_log.debug("Attempting to delete content "+uid);
	...
	public void deletePortletDocuments(
		...
		_log.debug("Attempting to delete portlet documents for portletId "+portletId);
